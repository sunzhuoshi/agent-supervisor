...
namespace AgentSupervisor
{
    public class NotificationHistory
    {
        ...
        {
            return JsonFileStore.LoadList<NotificationEntry>(Constants.NotificationHistoryFileName, "notification history");
        }
        ...
        public void Save()
        {
            lock (_lockObject)
            {
                JsonFileStore.SaveList(_entries, Constants.NotificationHistoryFileName, "notification history");
            }
        }
